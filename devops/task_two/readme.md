...
# Stage 2: Dockerized Full Stack Web Application Deployment

In this stage, you’ll deploy a provided full stack web application (React frontend and FastAPI + PostgreSQL backend) using Docker containers. You will also proxy both services to run on the same port using Traefik or Nginx Proxy Manager.
...
3. **Proxy Configuration (Traefik, HaProxy, or Nginx Proxy Manager)**
...
7. **Cloud Deployment**
   ...
   - Set up a domain for your application. If you don't have a domain, get a free subdomain from [Afraid DNS](https://freedns.afraid.org/).
...
Submit your task through the designated [submission form](https://forms.gle/DaeUy4gH632A4WSv6). Ensure you've:
...
The deadline for submissions is **Sunday, 7th July 2024, at 11:59 PM**.